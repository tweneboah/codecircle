          ...
          <div className="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
            <div className="text-center">
              ...
              <p className="mt-2 text-sm text-gray-600">
                Your account has been successfully created. You can now sign in and start connecting with other developers!
              </p>
              <div className="mt-6">
                <Link
                  href="/auth/login"
    ...
    <div className="min-h-screen bg-gray-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        ...
        <p className="mt-2 text-center text-sm text-gray-600">
          Or{' '}
          <Link href="/auth/login" className="font-medium text-[#fca311] hover:text-[#e8920e]">
            ...
            <div>
              ...
              <div className="mt-1">
                <textarea
                  ...
                  value={formData.bio}
                  onChange={handleChange}
                  className="appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md placeholder-gray-400 focus:outline-none focus:ring-[#fca311] focus:border-[#fca311] sm:text-sm"
